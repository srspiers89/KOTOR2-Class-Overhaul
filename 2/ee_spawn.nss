// ee_spawn.nss
//
// OnSpawn script for elite enemies
...
void main()
{
    ...
    //****** TREASURE PLACEMENT
    PlaceTreasurePeragus(OBJECT_SELF, Random(2)+1);
    ...
    // Turn the AI off briefly to give everything time to be configured.
    SetLocalBoolean(OBJECT_SELF, 87, TRUE);
    DelayCommand(2.0, SetLocalBoolean(OBJECT_SELF, 87, FALSE));
