...
114 Droid 2 Hazard
115 Droid 3 Hazard
132 Heat shield                 - Protects against energy weapons and heat damage. - RWT 12/08/03
*/
...
void main()
{
    ...
    if(nIndex == 99)
    {
        ...
        //ExecuteScript("ac_increase", GetSpellTargetObject());
    }
    else if(nIndex == 100)
    {
    ...
    else if(nIndex == 103)
    {
        ...
        ApplyEffectToObject(DURATION_TYPE_TEMPORARY, EffectACIncrease(5, AC_DEFLECTION_BONUS, 7), GetSpellTargetObject(), 200.0);
    }
    else if(nIndex == 104)
    {
    ...
    else if(nIndex == 132)//RWT-OEI 12/08/03
    {
        nShield = SHIELD_HEAT;
        nIcon = 91;
    }
